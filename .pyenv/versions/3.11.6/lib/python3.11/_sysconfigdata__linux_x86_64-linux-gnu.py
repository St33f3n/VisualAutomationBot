...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/home/steefen/.pyenv/versions/3.11.6/bin',
 'BINLIBDEST': '/home/steefen/.pyenv/versions/3.11.6/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': 'gcc -shared -L/home/steefen/.pyenv/versions/3.11.6/lib '
              '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib '
              '-L/home/steefen/.pyenv/versions/3.11.6/lib '
              '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/home/steefen/.pyenv/versions/3.11.6/include',
 'CONFIGURE_LDFLAGS': '-L/home/steefen/.pyenv/versions/3.11.6/lib '
                      '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/home/steefen/.pyenv/versions/3.11.6' "
                "'--enable-shared' "
                "'--libdir=/home/steefen/.pyenv/versions/3.11.6/lib' "
                "'LDFLAGS=-L/home/steefen/.pyenv/versions/3.11.6/lib "
                "-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib' "
                "'CPPFLAGS=-I/home/steefen/.pyenv/versions/3.11.6/include'",
 'CONFINCLUDEDIR': '/home/steefen/.pyenv/versions/3.11.6/include',
 'CONFINCLUDEPY': '/home/steefen/.pyenv/versions/3.11.6/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/tmp/python-build.20231108165437.222926/Python-3.11.6/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/tmp/python-build.20231108165437.222926/Python-3.11.6/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/home/steefen/.pyenv/versions/3.11.6/include '
             '-I/home/steefen/.pyenv/versions/3.11.6/include',
 'CXX': 'g++',
 ...
 'DESTDIRS': '/home/steefen/.pyenv/versions/3.11.6 '
             '/home/steefen/.pyenv/versions/3.11.6/lib '
             '/home/steefen/.pyenv/versions/3.11.6/lib/python3.11 '
             '/home/steefen/.pyenv/versions/3.11.6/lib/python3.11/lib-dynload',
 'DESTLIB': '/home/steefen/.pyenv/versions/3.11.6/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/home/steefen/.pyenv/versions/3.11.6/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/home/steefen/.pyenv/versions/3.11.6/include '
                   '/home/steefen/.pyenv/versions/3.11.6/include '
                   '/home/steefen/.pyenv/versions/3.11.6/include/python3.11 '
                   '/home/steefen/.pyenv/versions/3.11.6/include/python3.11',
 'INCLUDEDIR': '/home/steefen/.pyenv/versions/3.11.6/include',
 'INCLUDEPY': '/home/steefen/.pyenv/versions/3.11.6/include/python3.11',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -shared -L/home/steefen/.pyenv/versions/3.11.6/lib '
             '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib '
             '-L/home/steefen/.pyenv/versions/3.11.6/lib '
             '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/home/steefen/.pyenv/versions/3.11.6/lib/python3.11',
 'LIBDIR': '/home/steefen/.pyenv/versions/3.11.6/lib',
 ...
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                    ...
                    '-I/home/steefen/.pyenv/versions/3.11.6/include '
                    '-I/home/steefen/.pyenv/versions/3.11.6/include -fPIC '
                    '-fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/steefen/.pyenv/versions/3.11.6/lib/pkgconfig',
 'LIBPL': '/home/steefen/.pyenv/versions/3.11.6/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/steefen/.pyenv/versions/3.11.6/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/home/steefen/.pyenv/versions/3.11.6/share/man',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -std=c11 '
                   ...
                   '-I/home/steefen/.pyenv/versions/3.11.6/include -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/home/steefen/.pyenv/versions/3.11.6/lib '
                    '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib '
                    '-L/home/steefen/.pyenv/versions/3.11.6/lib '
                    '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib',
 ...
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/home/steefen/.pyenv/versions/3.11.6/lib '
               '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib '
               '-L/home/steefen/.pyenv/versions/3.11.6/lib '
               '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/home/steefen/.pyenv/versions/3.11.6/lib '
                     '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib '
                     '-L/home/steefen/.pyenv/versions/3.11.6/lib '
                     '-Wl,-rpath,/home/steefen/.pyenv/versions/3.11.6/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/python-build.20231108165437.222926/Python-3.11.6',
 'SCRIPTDIR': '/home/steefen/.pyenv/versions/3.11.6/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/python-build.20231108165437.222926/Python-3.11.6 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/python-build.20231108165437.222926/Python-3.11.6 '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './home/steefen/.pyenv/versions/3.11.6',
 'WASM_STDLIB': './home/steefen/.pyenv/versions/3.11.6/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/tmp/python-build.20231108165437.222926/Python-3.11.6',
 'abs_srcdir': '/tmp/python-build.20231108165437.222926/Python-3.11.6',
 'datarootdir': '/home/steefen/.pyenv/versions/3.11.6/share',
 'exec_prefix': '/home/steefen/.pyenv/versions/3.11.6',
 'prefix': '/home/steefen/.pyenv/versions/3.11.6',
 'srcdir': '.'}
